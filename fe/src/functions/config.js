let env
if (location.hostname.indexOf('localhost') >= 0 || location.hostname.indexOf('10.0') >= 0 || location.hostname.indexOf('172.19') >= 0) {
  env = {
